...
echo ""
echo "=== Next Step: Configure SSL/HTTPS (Recommended) ==="
echo ""
echo "To enable HTTPS with a trusted SSL certificate, run:"
echo "  sudo bash /opt/CasettaFit/app/setup_ssl.sh"
echo ""
echo "SSL Options:"
echo "  1. Let's Encrypt (free, trusted, auto-renewing)"
echo "  2. Self-signed certificate (testing/development)"
echo "  3. Upload custom certificate"
echo ""
echo "For detailed instructions, see: /opt/CasettaFit/SSL_SETUP.md"
echo ""
